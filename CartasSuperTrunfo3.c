...
int main () {
     ...
     float pib1;
     int turismo1;
     float densidadePop1, PerCapita1, superPoder1;
     ...
     float pib2;
     int turismo2;
     float densidadePop2, PerCapita2, superPoder2;
     ...
     superPoder1 = populacao1 + area1 + pib1 + turismo1 +PerCapita1 + (1 / densidadePop1);
     ...
     superPoder2 = populacao2 + area2 + pib2 + turismo2 +PerCapita2 + (1 / densidadePop2);
      ...
      printf("PIB per Capita: %.2f reais\n", PerCapita1);
       ...
       int Densidade = densidadePop1 < densidadePop2;
       int Capita = PerCapita1 > PerCapita2;
       int SuperPoder = superPoder1 > superPoder2;
    
       // Exibição das comparações
       printf("\nComparação de Cartas:\n");
       printf("População: Carta %d venceu (%d)\n", 2 - Populacao, Populacao);
       printf("Área: Carta %d venceu (%d)\n", 2 - Area, Area);
       printf("PIB: Carta %d venceu (%d)\n", 2- PIB, PIB);
       printf("Pontos Turísticos: Carta %d venceu (%d)\n", 2- Turismo, Turismo);
       printf("Densidade Populacional: Carta %d venceu (%d)\n", 2 - Densidade, Densidade);
       printf("PIB per Capita: Carta %d venceu (%d)\n", 2 - Capita, Capita);
       printf("Super Poder: Carta %d venceu (%d)\n", 2 - SuperPoder, SuperPoder);
